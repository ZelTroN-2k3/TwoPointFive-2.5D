...
.defines(function() { "use strict";
    window.MenuPause = ig.Menu.extend({
        items: [{
            text: 'RESUME',
            ok: function() {
                ig.game.menu = null; // This will also unpause the music, but just in case...
            }
        }, {
            text: 'BACK TO TITLE',
            ok: function() {
                ig.game.setTitle(); // This will also stop the music, but just in case...
                ig.music.stop(); // Stop the music, just in case.
            }
        }]
    });
