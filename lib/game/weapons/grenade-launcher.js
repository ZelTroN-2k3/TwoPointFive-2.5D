...
.defines(function(){
	...
	WeaponGrenadeLauncher = Weapon.extend({
		...
		weaponIconImage: new ig.Image( 'media/grenade-launcher-icon.png' ), // 🆕 Ajout de l'icône
		ammoIcon: null,
		weaponIcon: null,
		...
		init: function( ammo ) {
			...
			this.weaponIcon = new tpf.HudTile( this.weaponIconImage, 0, 96, 32); // 🆕 Icône de l'arme
			
			
			this.ammoIcon.setPosition(200, 460);
			this.weaponIcon.setPosition(960, 660); // Position de l’icône dans l'HUD
